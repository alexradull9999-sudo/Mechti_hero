      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="max-w-3xl mb-16 md:mb-24 space-y-4">
          ...
          <h2 className="font-serif text-4xl md:text-6xl font-light leading-tight">
            ...
            <span className="italic text-[#8B6F4E]">каждая деталь — вплоть до миллиметра</span>
          </h2>
          <p className="text-base md:text-lg text-[#322F2A] font-sans font-normal leading-relaxed max-w-2xl">
            Мы не рисуем «картинки из интернета», которые невозможно построить. Исключительно индивидуальный подход. Проектирование под каждый проект с использованием только премиальных материалов. Каждый дизайн-проект изначально разрабатывается под кураторством главного инженера строительного департамента холдинга.
          </p>
        </div>
