...
export default function RenovationDetails({ onScrollToSection }: RenovationDetailsProps) {
  const steps = [
    ...
    { title: "Сантехника и финишная электрика", desc: "Установка сантехнического элитного фаянса (Villeroy & Boch, Laufen, Antonio Lupi, Grohe, Hansgrohe, Boheme и другие премиальные бренды), розеток и выключателей JUNG, Berker, и другие премиальные европейские бренды." },
  ...
  const standards = [
    {
      ...
      desc: "Стандарт подготовки стен Q3 (под обои и высококачественную покраску) с допусками до 1 мм на 2 погонных метра. Возведение перегородок выполняется согласно ГОСТ и СНиП."
    },
    {
      icon: <ShieldCheck size={20} className="text-[#B8956A]" />,
      title: "Шумоизоляция и акустика",
      desc: "Шумоизоляция стен, потолков и перекрытий — современные многослойные системы с подтверждённым акустическим эффектом, соответствуют ГОСТ."
    },
    {
      icon: <Droplet size={20} className="text-[#B8956A]" />,
      title: "Инженерия и водоснабжение",
      desc: "Коллекторные узлы из нержавеющей стали Far, трубы Rehau, Uponor, и другие проверенные европейские системы с защитой от протечек, редукторы Honeywell, система автоперекрытия Neptun/Gidrolock с беспроводными датчиками в мокрых зонах."
    },
    {
    ...
    },
    {
      ...
      desc: "Распределённая система кондиционирования Daikin / Mitsubishi Electric с щелевыми адаптерами Schiberg, исключающими сквозняки. Увлажнение воздуха и приточная вентиляция с сапфировыми распылителями канального типа — поддержание оптимальной влажности 40-60% во всех помещениях для здоровья жителей и сохранности отделки."
    }
  ];
