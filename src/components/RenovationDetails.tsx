...
export default function RenovationDetails({ onScrollToSection }: RenovationDetailsProps) {
  const steps = [
    ...
    { title: "Черновые работы согласно всем СНиП и нормам", desc: "Выравнивание пола с шумо-гидро изоляцией." },
    { title: "Инженерные решения высокой надежности", desc: "Электрика и автоматика (ABB, Schneider Electric), сантехника, отопление, вентиляция, скрытая канальная топовое кондиционирование, увлажнение с сапфировыми распылителями, личные сценарии." },
    { title: "Сверхточная чистовая отделка", desc: "Малярные работы согласно стандарту Q3+ и выше, укладка инженерной паркетной доски, подрезка и шлифовка плит мрамора под углом 45°." },
    { title: "Сантехника и финишная электрика", desc: "Установка сантехнического элитного фаянса (Villeroy & Boch, Laufen, Antonio Lupi, Grohe, Hansgrohe, Gessi, Boheme и другие премиальные бренды), розеток и выключателей JUNG, Berker." },
    { title: "Инсталляция мебели", desc: "Исключительно индивидуальный подход, с проектированием под каждый проект и подбор оригинальной мебели от ведущих мировых премиальных брендов (Minotti, Poltrona Frau, B&B Italia, Cassina, Flexform и др.). Сборка и монтаж встроенной кухонной и гардеробной систем по лазерным координатам и лазерным линейкам." },
    { title: "Комплексное декорирование", desc: "Индивидуальный подход расстановки по своим местам каждой детали созданного проекта — чашек, ложек, цветов, предметов искусства. Размещение настенных панелей, инсталляция зеркал с интегрированными контурами подсветки." },
    ...
    { title: "Передача готового объекта", desc: "Передача готового объекта, готового для жизни. Передача ключей, папки исполнительной документации под заезд." }
  ];
  ...
  const standards = [
    {
      ...
      title: "Выравнивание, малярные разделы (Q3+/Q4)",
      desc: "Стандарт малярных и шумоизоляционных работ — Q3+ и выше (Q4 — по запросу, отдельная стоимость). Допуски до 1 мм. Возведение перегородок выполняется согласно ГОСТ и СНиП."
    },
    {
      icon: <ShieldCheck size={20} className="text-[#B8956A]" />,
      title: "Шумоизоляция и акустика",
      desc: "Шумоизоляция стен и перекрытий выполняется по ГОСТ и СНиП. Современные многослойные системы с гарантированным акустическим комфортом."
    },
    {
      icon: <Droplet size={20} className="text-[#B8956A]" />,
      title: "Сантехника и водоснабжение",
      desc: "Коллекторные узлы с защитой от протечек. Используем элитный фаянс и смесители: Villeroy & Boch, Laufen, Antonio Lupi, Grohe, Hansgrohe, Gessi, Boheme и другие."
    },
    {
      icon: <Zap size={20} className="text-[#B8956A]" />,
      title: "Электрика и автоматика",
      desc: "Безгалогенные кабели ГОСТ. Установочные механизмы и щиты управления ведущих европейских брендов: ABB, Schneider Electric, JUNG, Berker и другие."
    },
    {
      icon: <Wind size={20} className="text-[#B8956A]" />,
      title: "Климатические системы",
      desc: "Электрика, сантехника, отопление, вентиляция, скрытая канальная топовая климат-система, увлажнение воздуха с сапфировыми распылителями, индивидуальные сценарии освещения и микроклимата под образ жизни."
    }
  ];
