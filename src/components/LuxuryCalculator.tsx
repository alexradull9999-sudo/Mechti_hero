...
const SECTIONS_APARTMENT: Section[] = [
  ...
  },
  {
    ...
    subtitle: 'Все работы выполняются по СНиПам и ГОСТам. Стандарт качества малярных и шумоизоляционных работ — не ниже Q3+ и выше (Q4 — по запросу, дополнительная стоимость).',
    categories: [
      {
      ...
      },
      {
        ...
        description: 'Выравнивание геометрии стен по маякам с точностью до миллиметра под Q3+ и выше',
        rate: 7200,
      },
      {
        key: 'const_painting',
  ...
  },
  {
    ...
    categories: [
      ...
      },
      {
        ...
        description: 'Villeroy & Boch, Laufen, Antonio Lupi, Grohe, Hansgrohe, Gessi, Boheme и другие премиальные бренды: душевые комплекты, ванна, унитазы с инсталляцией, смесители, аксессуары',
        rate: 11400,
      }
    ]
  },
  {
    ...
    title: 'МЕБЕЛЬ',
    displayName: 'Мебель',
    tooltip: 'Индивидуальная меблировка, полная комплектация любой сложности от Комплектации Мечты.',
    subtitle: 'Полная комплектация оригинальной мебелью от ведущих премиальных брендов (Minotti, Poltrona Frau, B&B Italia, Cassina, Flexform). Индивидуальные мебельные проекты, гарантия на немецкие инновационные механизмы Blum и Hettich.',
    categories: [
      {
        key: 'kitchen',
        title: 'Кухонный гарнитур со столешницей',
        description: 'Полная комплектация по кухне в партнерстве с премиальными брендами, столешница и фартук из кварца, скрытая европейская фурнитура Blum / Hettich',
        rate: 28400,
      },
      {
        key: 'cabinet',
      ...
      },
      {
        ...
        description: 'Оригинальные диваны, кресла, кровати с изголовьем от топовых премиальных мировых брендов-партнеров (Minotti, Poltrona Frau, B&B Italia, Cassina, Flexform и др.), матрасы премиум класса, постельное бельё.',
        rate: 14000,
      }
    ]
  },
