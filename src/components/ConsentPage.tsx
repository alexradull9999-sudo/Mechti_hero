...
export default function ConsentPage() {
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = "Согласие на обработку персональных данных — ГК «Всё начинается с Мечты»";
  }, []);
      ...
      <div className="max-w-3xl mx-auto space-y-12">
        ...
        <div className="space-y-8 text-sm text-[#C4BEB3] leading-relaxed font-light text-justify">
          ...
          <section className="space-y-3">
            ...
            <p>
              Я, действуя свободно, своей волей и в своем интересе, выражаю свое согласие ГК «Всё начинается с Мечты» в лице ИП Постриганев Ю.В. (Оператор), ИНН: 235701234508, ОГРНИП: 312231120100045, адрес: 123317, г. Москва, Пресненская наб., д. 6, стр. 2, на автоматизированную и неавтоматизированную обработку моих персональных данных.
            </p>
          </section>
